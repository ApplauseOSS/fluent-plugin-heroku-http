...
class HttpContentNegotiationInputTest < Test::Unit::TestCase
  class << self
    def startup
  ...
  def create_driver(conf = CONFIG)
    Fluent::Test::Driver::Input.new(Fluent::Plugin::HttpContentNegotiationInput).configure(conf)
  end
